...
--Task 19:
SELECT s.SaleID, s.ProductID, s.SaleAmount
FROM Sales s
INNER JOIN Customers c ON s.CustomerID = c.CustomerID
WHERE c.Country = 'USA';

--Task 20:
SELECT o.OrderID, o.TotalAmount, c.FirstName
FROM Orders o
...
--Task 24:
SELECT e.Name AS ManagerName, m.Name AS ManagedEmployee, e.Salary AS ManagerSalary, m.Salary AS ManagedEmployeeSalary
FROM Employees e
